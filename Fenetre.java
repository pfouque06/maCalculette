...
public class Fenetre extends JFrame implements ActionListener, KeyListener {
	...
	public Fenetre() {
		...
		File fileFont;
		try {
			// get workingSpace Directory
			String projectName = PackageTools.getProjectName();
			String workSpaceDir = PackageTools.getWorkSpaceDir();
			logger.logging("projectName: "+projectName);	// -> myApps
			logger.logging("workSpaceDir: "+workSpaceDir);
			...
			fileFont = new File(workSpaceDir + "/" + "font/PixelOperator.ttf");
